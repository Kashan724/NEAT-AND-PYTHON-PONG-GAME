...
class Game:
    ...
    def _draw_divider(self):
        for i in range(10, self.window_height, self.window_height//20):
            if i % 2 == 1:
                continue
            pygame.draw.rect(
                self.window, self.YELLOW, (self.window_width//2 - 5, i, 10, self.window_height//20))
    ...
    def loop(self):
        ...
        if self.left_score+self.right_score>=20 and self.left_score+self.right_score<40:
            Level1=True
        ...
        if self.left_score+self.right_score>=40 and self.left_score+self.right_score<WINNING_SCORE:
            Level2=True
            Level1=False
            win_text=" Level 2 "
            text = SCORE_FONT.render(win_text, 1, WHITE)
        ...
        if Level2:
            ...
            clock2=pygame.time.Clock()
            clock2.tick(6000)
        if self.left_score+self.right_score>=WINNING_SCORE:
            Level3=True
            Level1=False
            Level2=False
